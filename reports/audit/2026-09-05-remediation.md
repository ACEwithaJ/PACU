# CI report — audit/2026-09-05-remediation

Commit: c4300d7718c3a776c29d66a5d32ff02164507441  ·  Run: https://github.com/ACEwithaJ/PACU/actions/runs/34003686635
...
PASS  clean: no findings, exit 0
      validate: 1 ledger rows, 1 days, 1 cards; 0 errors, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-z8qvLo/clean-review.md
PASS  rule-00-difficulty: error on 00 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-00-difficulty-review.md
PASS  rule-00-exam: error on 00 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-00-exam-review.md
PASS  rule-01: error on 01 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-01-review.md
PASS  rule-02: error on 02 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-02-review.md
PASS  rule-03: error on 03 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-03-review.md
PASS  rule-04: error on 04 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 4 errors, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-04-review.md
PASS  rule-04-card: error on 04 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 1 cards; 1 error, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-04-card-review.md
PASS  rule-05: WARN on 05 only, exit 0
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 0 errors, 1 warning; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-05-review.md
PASS  rule-05 --strict: error on 05 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-05-strict-review.md (strict)
PASS  rule-06: error on 06 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-06-review.md
PASS  rule-07: error on 07 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-07-review.md
PASS  rule-08: error on 08 only, exit 1
      ...
      validate: 1 ledger rows, 2 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-08-review.md
PASS  rule-09: WARN on 09 only, exit 0
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 0 errors, 1 warning; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-09-review.md
PASS  rule-09 --strict: error on 09 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-09-strict-review.md (strict)
PASS  rule-10: error on 10 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-10-review.md
PASS  rule-10-card: error on 10 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 1 cards; 1 error, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-10-card-review.md
PASS  rule-11: error on 11 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-11-review.md
PASS  rule-12: error on 12 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 4 errors, 0 warnings; 4 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-12-review.md
PASS  rule-13: error on 13 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-13-review.md
PASS  rule-14: error on 14 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-z8qvLo/rule-14-review.md
...
WARN RULE-09 src/content/ledger/white-1999.yaml 12 white-1999: access unverified (docs/ledger-debt.md §1)
validate: 107 ledger rows, 20 days, 0 cards; 0 errors, 53 warnings; 40 review items -> docs/content-review.md
[2m01:21:52[22m [34m[content][39m Syncing content
[33m[1m01:21:52[22m [WARN] [glob-loader][39m No files found matching "card-*.md" in directory "src/content/cards"
[2m01:21:52[22m [34m[content][39m Synced content
[2m01:21:52[22m [34m[types][39m Generated [2m848ms[22m
[2m01:21:52[22m [34m[build][39m output: [34m"static"[39m
[2m01:21:52[22m [34m[build][39m mode: [34m"static"[39m
[2m01:21:52[22m [34m[build][39m directory: [34m/home/runner/work/PACU/PACU/dist/[39m
[2m01:21:52[22m [34m[build][39m Collecting build info...
[2m01:21:52[22m [34m[build][39m [32m✓ Completed in 859ms.[39m
[2m01:21:52[22m [34m[build][39m Building static entrypoints...
[2m01:21:53[22m [34m[vite][39m [32m✓ built in 981ms[39m
[2m01:21:53[22m [34m[build][39m [32m✓ Completed in 1.01s.[39m

[42m[30m building client (vite) [39m[49m
[2m01:21:53[22m [34m[vite][39m transforming...
[2m01:21:53[22m [34m[vite][39m [32m✓[39m 1 modules transformed.
[2m01:21:53[22m [34m[vite][39m rendering chunks...
[2m01:21:53[22m [34m[vite][39m [32m✓ built in 15ms[39m

[42m[30m generating static routes [39m[49m
[2m01:21:53[22m [32m▶[39m src/pages/404.astro
[2m01:21:53[22m   [34m└─[39m [2m/404.html[22m [2m(+5ms)[22m 
[2m01:21:53[22m [32m▶[39m src/pages/about.astro
[2m01:21:53[22m   [34m└─[39m [2m/about/index.html[22m [2m(+1ms)[22m 
[2m01:21:53[22m [32m▶[39m src/pages/c/[id].astro
The collection "cards" does not exist or is empty. Please check your content config file for errors.
[2m01:21:53[22m [32m▶[39m src/pages/d/[id].astro
[2m01:21:53[22m   [34m├─[39m [2m/d/day-01/index.html[22m [2m(+10ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-03/index.html[22m [2m(+5ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-02/index.html[22m [2m(+6ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-04/index.html[22m [2m(+5ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-05/index.html[22m [2m(+5ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-06/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-08/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-09/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-10/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-07/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-11/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-12/index.html[22m [2m(+2ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-13/index.html[22m [2m(+2ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-14/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-15/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-16/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-17/index.html[22m [2m(+2ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-18/index.html[22m [2m(+2ms)[22m 
[2m01:21:53[22m   [34m├─[39m [2m/d/day-19/index.html[22m [2m(+4ms)[22m 
[2m01:21:53[22m   [34m└─[39m [2m/d/day-20/index.html[22m [2m(+3ms)[22m 
[2m01:21:53[22m [32m▶[39m src/pages/index.astro
[2m01:21:53[22m   [34m└─[39m [2m/index.html[22mThe collection "cards" does not exist or is empty. Please check your content config file for errors.
 [2m(+4ms)[22m 
[2m01:21:53[22m [35mλ[39m src/pages/sitemap.xml.ts
[2m01:21:53[22m   [34m└─[39m [2m/sitemap.xml[22mThe collection "cards" does not exist or is empty. Please check your content config file for errors.
 [2m(+2ms)[22m 
[2m01:21:53[22m [32m✓ Completed in 115ms.
[39m
[2m01:21:53[22m [34m[build][39m 23 page(s) built in [1m2.01s[22m
[2m01:21:53[22m [34m[build][39m [1mComplete![22m
```
