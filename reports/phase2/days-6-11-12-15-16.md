...
Commit: 32bbe2d594390bdc19f7c8f88a1961bdbbdef5c6  ·  Run: https://github.com/ACEwithaJ/PACU/actions/runs/33980744908
...
PASS  clean: no findings, exit 0
      validate: 1 ledger rows, 1 days, 1 cards; 0 errors, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-yCUTVs/clean-review.md
PASS  rule-00-difficulty: error on 00 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-00-difficulty-review.md
PASS  rule-00-exam: error on 00 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-00-exam-review.md
PASS  rule-01: error on 01 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-01-review.md
PASS  rule-02: error on 02 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-02-review.md
PASS  rule-03: error on 03 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-03-review.md
PASS  rule-04: error on 04 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 4 errors, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-04-review.md
PASS  rule-04-card: error on 04 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 1 cards; 1 error, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-04-card-review.md
PASS  rule-05: WARN on 05 only, exit 0
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 0 errors, 1 warning; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-05-review.md
PASS  rule-05 --strict: error on 05 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-05-strict-review.md (strict)
PASS  rule-06: error on 06 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-06-review.md
PASS  rule-07: error on 07 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-07-review.md
PASS  rule-08: error on 08 only, exit 1
      ...
      validate: 1 ledger rows, 2 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-08-review.md
PASS  rule-09: WARN on 09 only, exit 0
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 0 errors, 1 warning; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-09-review.md
PASS  rule-09 --strict: error on 09 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-09-strict-review.md (strict)
PASS  rule-10: error on 10 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-10-review.md
PASS  rule-10-card: error on 10 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 1 cards; 1 error, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-10-card-review.md
PASS  rule-11: error on 11 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-11-review.md
PASS  rule-12: error on 12 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 4 errors, 0 warnings; 4 review items -> ../../../../../tmp/pacu-selftest-yCUTVs/rule-12-review.md
...
WARN RULE-09 src/content/ledger/sun-2015.yaml 12 sun-2015: access unverified (docs/ledger-debt.md §1)
validate: 53 ledger rows, 14 days, 0 cards; 0 errors, 20 warnings; 42 review items -> docs/content-review.md
[2m17:22:32[22m [34m[content][39m Syncing content
[33m[1m17:22:32[22m [WARN] [glob-loader][39m No files found matching "card-*.md" in directory "src/content/cards"
[2m17:22:32[22m [34m[content][39m Synced content
[2m17:22:32[22m [34m[types][39m Generated [2m978ms[22m
[2m17:22:32[22m [34m[build][39m output: [34m"static"[39m
[2m17:22:32[22m [34m[build][39m mode: [34m"static"[39m
[2m17:22:32[22m [34m[build][39m directory: [34m/home/runner/work/PACU/PACU/dist/[39m
[2m17:22:32[22m [34m[build][39m Collecting build info...
[2m17:22:32[22m [34m[build][39m [32m✓ Completed in 990ms.[39m
