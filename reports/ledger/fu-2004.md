# CI report — ledger/fu-2004

Commit: b3a4480e7c98b6adbc3425cdc0a4ae036650a2f3  ·  Run: https://github.com/ACEwithaJ/PACU/actions/runs/33975278188
...
PASS  clean: no findings, exit 0
      validate: 1 ledger rows, 1 days, 1 cards; 0 errors, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-fYa7ED/clean-review.md
PASS  rule-00-difficulty: error on 00 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-00-difficulty-review.md
PASS  rule-00-exam: error on 00 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-00-exam-review.md
PASS  rule-01: error on 01 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-01-review.md
PASS  rule-02: error on 02 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-02-review.md
PASS  rule-03: error on 03 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-03-review.md
PASS  rule-04: error on 04 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 4 errors, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-04-review.md
PASS  rule-04-card: error on 04 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 1 cards; 1 error, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-04-card-review.md
PASS  rule-05: WARN on 05 only, exit 0
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 0 errors, 1 warning; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-05-review.md
PASS  rule-05 --strict: error on 05 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-05-strict-review.md (strict)
PASS  rule-06: error on 06 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-06-review.md
PASS  rule-07: error on 07 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-07-review.md
PASS  rule-08: error on 08 only, exit 1
      ...
      validate: 1 ledger rows, 2 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-08-review.md
PASS  rule-09: WARN on 09 only, exit 0
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 0 errors, 1 warning; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-09-review.md
PASS  rule-09 --strict: error on 09 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-09-strict-review.md (strict)
PASS  rule-10: error on 10 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-10-review.md
PASS  rule-10-card: error on 10 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 1 cards; 1 error, 0 warnings; 1 review item -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-10-card-review.md
PASS  rule-11: error on 11 only, exit 1
      ...
      validate: 1 ledger rows, 0 days, 0 cards; 1 error, 0 warnings; 0 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-11-review.md
PASS  rule-12: error on 12 only, exit 1
      ...
      validate: 1 ledger rows, 1 days, 0 cards; 4 errors, 0 warnings; 4 review items -> ../../../../../tmp/pacu-selftest-fYa7ED/rule-12-review.md
...
validate: 53 ledger rows, 1 days, 0 cards; 0 errors, 22 warnings; 1 review item -> docs/content-review.md
```
...
WARN RULE-09 src/content/ledger/sun-2015.yaml 12 sun-2015: access unverified (docs/ledger-debt.md §1)
validate: 53 ledger rows, 1 days, 0 cards; 0 errors, 22 warnings; 1 review item -> docs/content-review.md
[2m15:35:58[22m [34m[content][39m Syncing content
[33m[1m15:35:58[22m [WARN] [glob-loader][39m No files found matching "card-*.md" in directory "src/content/cards"
[2m15:35:58[22m [34m[content][39m Synced content
[2m15:35:58[22m [34m[types][39m Generated [2m632ms[22m
[2m15:35:58[22m [34m[build][39m output: [34m"static"[39m
[2m15:35:58[22m [34m[build][39m mode: [34m"static"[39m
[2m15:35:58[22m [34m[build][39m directory: [34m/home/runner/work/PACU/PACU/dist/[39m
[2m15:35:58[22m [34m[build][39m Collecting build info...
[2m15:35:58[22m [34m[build][39m [32m✓ Completed in 645ms.[39m
[2m15:35:58[22m [34m[build][39m Building static entrypoints...
[2m15:35:59[22m [34m[vite][39m [32m✓ built in 1.09s[39m
[2m15:35:59[22m [34m[build][39m [32m✓ Completed in 1.12s.[39m

[42m[30m building client (vite) [39m[49m
[2m15:35:59[22m [34m[vite][39m transforming...
[2m15:35:59[22m [34m[vite][39m [32m✓[39m 1 modules transformed.
[2m15:35:59[22m [34m[vite][39m rendering chunks...
[2m15:35:59[22m [34m[vite][39m [32m✓ built in 20ms[39m

[42m[30m generating static routes [39m[49m
[2m15:35:59[22m [32m▶[39m src/pages/c/[id].astro
The collection "cards" does not exist or is empty. Please check your content config file for errors.
[2m15:35:59[22m [32m▶[39m src/pages/d/[id].astro
[2m15:35:59[22m   [34m└─[39m [2m/d/day-03/index.html[22m [2m(+9ms)[22m 
[2m15:35:59[22m [32m▶[39m src/pages/index.astro
[2m15:35:59[22m   [34m└─[39m [2m/index.html[22mThe collection "cards" does not exist or is empty. Please check your content config file for errors.
 [2m(+3ms)[22m 
[2m15:35:59[22m [32m✓ Completed in 37ms.
[39m
[2m15:35:59[22m [34m[build][39m 2 page(s) built in [1m1.84s[22m
[2m15:35:59[22m [34m[build][39m [1mComplete![22m
```
