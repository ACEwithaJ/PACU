---
id: day-20
title: Anaphylaxis presents as hypotension, and the dose follows the grade
claim: Perioperative anaphylaxis presents as hypotension far more often than as a rash, is delayed when the trigger is chlorhexidine or a dye, and is treated with intravenous epinephrine in doses scaled to its grade, while latex has all but disappeared as a cause.
...
quiz:
  - id: pacu-d20-q1
    ...
    teachingPoint: "Hypotension, not rash, is how perioperative anaphylaxis usually announces itself."
    difficulty: basic
    examAlignment: [ABA-BASIC, ITE, nursing]
    tags: [anaphylaxis, hemodynamics]
    options:
      - text: "Hypotension, in 46% of cases"
        correct: true
        explanation: "Presenting features were hypotension 46%, bronchospasm 18%, tachycardia 9.8%, desaturation 4.7%, bradycardia 3% and reduced or absent capnography 2.3%, and every patient was hypotensive at some point during the episode."
      - text: "Urticaria, in most cases"
        correct: false
        explanation: "Skin signs may be absent, especially in the severe grades, and were not the commonest presentation."
      - text: "Bronchospasm, in most cases"
        correct: false
        explanation: "Bronchospasm presented in 18%, second to hypotension."
      - text: "Cardiac arrest, in most cases"
        correct: false
        explanation: "There were 40 cardiac arrests and 10 deaths among 266 reports; arrest was the outcome in a minority."
  - id: pacu-d20-q2
    stem: "According to NAP6, which culprit agents produced a delayed onset of anaphylaxis?"
    teachingPoint: "Chlorhexidine and Patent Blue dye were delayed; neuromuscular blockers and antibiotics were rapid; latex produced no cases at all."
    difficulty: advanced
    examAlignment: [ABA-ADVANCED, ITE]
    tags: [anaphylaxis, pharmacology]
    options:
      - text: "Chlorhexidine and Patent Blue dye"
        correct: true
        explanation: "Onset was rapid for neuromuscular blocking agents and antibiotics but delayed with chlorhexidine and Patent Blue dye. Of 199 identified culprits, antibiotics accounted for 94, neuromuscular blockers 65, chlorhexidine 18 and Patent Blue 9. There were no reports of latex anaphylaxis."
      - text: "Latex and chlorhexidine"
        correct: false
        explanation: "NAP6 recorded no latex anaphylaxis, and the consensus paper describes latex reactions as decreasing. The delayed culprits were chlorhexidine and the dye."
      - text: "Neuromuscular blocking agents"
        correct: false
        explanation: "Onset with neuromuscular blockers was rapid."
      - text: "Antibiotics"
        correct: false
        explanation: "Onset with antibiotics was rapid, though they were the commonest culprit."
  - id: pacu-d20-q3
    stem: "Using the 2019 international consensus recommendations, what is the initial intravenous epinephrine dose for a Grade III reaction in an adult, and what if there is no response at 2 minutes?"
    teachingPoint: "Fifty micrograms for Grade III, escalating to 200 at 2 minutes and repeated every 2 minutes, with a litre of crystalloid."
    difficulty: expert
    examAlignment: [ABA-ADVANCED, ITE, nursing]
    tags: [anaphylaxis, pharmacology, sequencing]
    options:
      - text: "50 micrograms intravenously, or 100 if unresponsive to other vasopressors or bronchodilators; escalate to 200 micrograms at 2 minutes and repeat every 2 minutes; crystalloid 1 litre, repeated up to 30 mL/kg"
        correct: true
        explanation: "Grade III is life-threatening mono- or multi-organ involvement. Grade II starts at 20 micrograms, escalating to 50; Grade IV is 1 mg per advanced life support. If there is no intravenous access, 300 micrograms intramuscularly. Refractory reactions after more than 10 minutes double the dose and, after more than three boluses, start an infusion."
      - text: "1 mg intravenously, as for cardiac arrest"
        correct: false
        explanation: "1 mg is the Grade IV dose, for cardiac or respiratory arrest. Giving it for a Grade III reaction is the overdose the grading exists to prevent."
      - text: "20 micrograms, and wait 10 minutes"
        correct: false
        explanation: "20 micrograms is the Grade II starting dose, and the interval for escalation is 2 minutes, not 10."
      - text: "Sugammadex first, if a neuromuscular blocker was given"
        correct: false
        explanation: "The consensus statement is explicit: sugammadex has no immediate role in resuscitation of suspected anaphylaxis."
---
## Why it matters
...
The non-allergic differential in the same document is the PACU's checklist for the hypotensive patient: relative anaesthetic overdose, neuraxial vasodilatation, bone cement implantation syndrome, amniotic fluid embolism, pulmonary embolism, tricyclic drugs, bleeding and other shock for isolated hypotension; asthma, airway hyperreactivity, inadequate depth, tube malposition and aspiration for isolated bronchospasm; and airway manipulation, ACE-inhibitor angioedema with onset 1 to 8 h after surgery, and hereditary or acquired angioedema for isolated angioedema [[garvey-2019]].
...
Do not reach for sugammadex as a treatment for suspected anaphylaxis, whatever the neuromuscular blocker was; the consensus is explicit that it has no immediate role [[garvey-2019]]. Send the tryptase at the times the consensus specifies, and refer for investigation, because the next anaesthetic depends on knowing the culprit [[garvey-2019]].
