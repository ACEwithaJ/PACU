---
id: day-16
title: Handover is a transfer of responsibility, and half the items still go missing
claim: Handover is a measurable process in which omissions can be counted against a defined list, and a written checklist reliably improves the transfer of information, though even with a checklist under half the items were handed over and no study has shown a change in mortality or length of stay.
...
quiz:
  - id: pacu-d16-q1
    ...
    options:
      ...
      - text: It did not change
        correct: false
        explanation: The written checklist produced a measurable rise. It was verbal instruction alone that changed nothing.
      - text: It fell, because the checklist took too long
        correct: false
  ...
  - id: pacu-d16-q2
    ...
    options:
      - text: ICU mortality and length of stay did not change, while handoff duration roughly doubled
        correct: true
        explanation: Information omissions out of 13 topics fell, handoff duration rose from 4.1 (SD 3.3) to 8.0 (SD 3.9) minutes, and ICU mortality and length of stay did not change. It is a before-and-after cohort, not a trial.
      - text: ICU mortality fell significantly
        correct: false
        explanation: Mortality did not change. This is the reason the day's claim stops at information transfer.
      - text: Length of stay fell by two days
        correct: false
        explanation: Length of stay did not change.
      - text: The study measured only satisfaction
        correct: false
...
The multicenter successor trial still has no results. Its registry record was re-checked on 2026-09-06: it is enrolling by invitation, holds no posted results, and its estimated primary completion and study completion dates of 31 July 2026 have both passed without an update, the record having last been verified in August 2025. The only 2026 output is a pre-implementation methods paper. Nothing on this page rests on it, and it should not be quoted as a source until it reports.
