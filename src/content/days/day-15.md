...
quiz:
  - id: pacu-d15-q1
    ...
    options:
      - text: The literature is insufficient to evaluate the benefits of requiring it, and 85% of surveyed members supported not requiring it
        correct: true
        explanation: Section V states the literature is insufficient to evaluate the benefits of requiring patients to urinate before discharge, and the accompanying survey recorded 85% support for not requiring voiding before discharge.
  ...
  - id: pacu-d15-q2
    stem: "Which discharge requirement did the ASA member survey reported in the 2013 guideline support most strongly?"
    teachingPoint: The one requirement that survived the survey is the escort, not the drink or the void.
    difficulty: basic
    examAlignment: [ABA-BASIC, ITE, nursing]
    tags: [discharge, ambulatory]
    options:
      - text: Requiring a responsible individual to accompany the patient home, at 95%
        correct: true
        explanation: Support for requiring a responsible individual to accompany the patient home was 95%. Support for not requiring voiding was 85%, and for not requiring a mandatory minimum stay was 85%. Requiring patients to drink water was among the interventions members did not support.
      - text: Requiring patients to drink water before discharge
        correct: false
        explanation: That was listed among the interventions members did not support.
      - text: A mandatory minimum stay in recovery
        correct: false
        explanation: 85% supported not requiring a mandatory minimum stay.
      - text: Requiring patients to urinate before discharge
        correct: false
        explanation: 85% supported not requiring it.
  - id: pacu-d15-q3
    stem: "The 2013 guideline says the literature is insufficient on voiding, then reports an opinion survey. What kind of evidence is that, and how should a resident describe it?"
    teachingPoint: An absence of evidence plus a poll is not trial evidence; say what it is.
    difficulty: expert
    examAlignment: [ABA-ADVANCED, ITE]
    tags: [discharge, evidence-appraisal]
    options:
      ...
      - text: Proof that voiding requirements cause harm
        correct: false
        explanation: Nothing on this page tests harm from a voiding requirement. The claim is that the requirement has no evidentiary basis, not that it is harmful.
      - text: Evidence that can be ignored because it is old
        correct: false
        explanation: The guideline is more than a decade old and no successor practice guideline has been found, which is a reason to check currency, not to ignore it.
---
## Why it matters
