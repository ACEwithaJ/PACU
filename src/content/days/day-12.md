---
id: day-12
title: Delirium screening starts in the PACU
claim: Postoperative delirium is a diagnosis that begins in the recovery room, because the current European guideline requires screening with a validated tool from the day of surgery onward, while stating that its own certainty of evidence runs from very low to moderate.
...
quiz:
  - id: pacu-d12-q1
    stem: "The 2024 ESAIC guideline on postoperative delirium requires screening with a validated tool. When, and for how long?"
    teachingPoint: The sentence that puts delirium screening inside the PACU is a frequency and a start time.
    difficulty: basic
    examAlignment: [ABA-BASIC, ITE, nursing]
    tags: [delirium, guidelines, geriatrics]
    options:
      - text: At least once daily for at least three days, starting in the recovery room or PACU on the day of surgery, or at latest on postoperative day 1
        correct: true
        explanation: That is the guideline's requirement, and it is the sentence this day is built around. Screening is not a ward task that begins later.
      - text: Once, on the morning of postoperative day 1
        correct: false
        explanation: The requirement is at least once daily for at least three days, and it starts on the day of surgery where possible.
      - text: Only when a nurse reports confusion
        correct: false
        explanation: Screening on suspicion is what misses the hypoactive form. The guideline requires routine screening with a validated tool.
      - text: Continuously with an automated monitor
        correct: false
        explanation: The guideline specifies a validated screening tool applied at least daily, not a monitor.
  - id: pacu-d12-q2
