...
quiz:
  - id: pacu-d11-q1
    stem: "What does the joint ESRA/ASRA committee practice advisory say about regional anaesthesia and acute compartment syndrome?"
    teachingPoint: The strongest society statement finds no evidence that a block increases the risk or delays the diagnosis, and its scope is paediatric.
    difficulty: advanced
    examAlignment: [ABA-ADVANCED, ITE]
    tags: [regional, evidence-appraisal]
    options:
      - text: There are no current evidence-based data that regional anaesthesia increases the risk of acute compartment syndrome or delays its diagnosis
        correct: true
        explanation: That is the advisory's statement, with the caveat that high-level evidence is not available and most recommendations rest on Evidence B studies. The advisory is paediatric in scope, which the page says openly.
      - text: Regional anaesthesia is contraindicated in any patient at risk of compartment syndrome
        correct: false
        explanation: The advisory does not say that. It finds no evidence-based data for the masking claim.
      - text: Regional anaesthesia has been shown in randomised trials not to delay diagnosis
        correct: false
      ...
      - text: The question does not arise in paediatric practice
        correct: false
        explanation: The advisory is specifically paediatric, which is the source of its limitation for an adult curriculum.
  - id: pacu-d11-q2
  ...
  - id: pacu-d11-q3
    stem: "The 2018 ASRA interim update on local anaesthetic systemic toxicity is the source on this page for which point?"
    ...
    options:
      - text: That case presentations have changed, including delayed and atypical presentations, and that ultrasound guidance has a preventive role
        correct: true
        explanation: The 2018 update covers mechanisms of lipid resuscitation, updated frequency estimates, the preventive role of ultrasound guidance, changes in presentation patterns, and the limited evidence around local infiltration anaesthesia and liposomal bupivacaine.
      ...
      - text: The exact lipid emulsion dose in millilitres per kilogram
        correct: false
...
The lipid emulsion dose is on the corrected ASRA checklist: for a patient over 70 kg, a bolus of about 100 mL over 2 to 3 min then an infusion of about 250 mL over 15 to 20 min; under 70 kg, a bolus of about 1.5 mL/kg over 2 to 3 min then about 0.25 mL/kg/min; if unstable, repeat the bolus and double the infusion; maximum lipid dose 12 mL/kg; epinephrine in smaller than normal doses, starting below 1 µg/kg; avoid local anaesthetics, beta-blockers, calcium channel blockers and vasopressin; benzodiazepines preferred for seizures; observe for 2 h after a seizure or 4 to 6 h after cardiovascular instability [[neal-2021-checklist]]. The society states that the checklist is under review with an update expected in early 2027 [[neal-2021-checklist]].

The interscalene block's effect on the diaphragm is not a complication but a consequence: ipsilateral hemidiaphragmatic paresis on ultrasound in 13 of 13 patients within 5 min of a paraesthesia-technique block with 34 to 52 mL of 1.5% mepivacaine, resolving by 3 to 5 h [[urmey-1991]]. In a prospective series of 520 interscalene blocks for shoulder surgery, acute complications were one pneumothorax (0.2%) and one episode of central nervous system toxicity (0.2%); symptoms such as paraesthesia or non-surgical pain were present in 14% at 10 days, 7.9% at one month, 0.9% at six months and 0.2% at nine months [[borgeat-2001]]. Horner syndrome is not reported in that abstract: [NUMBER NEEDED: incidence of Horner syndrome after interscalene block]. Pneumothorax after ultrasound-guided supraclavicular or infraclavicular block occurred in 4 of 6366 blocks (0.06%, 95% CI 0.001 to 0.124), three of the four presenting after a two-day latency, against a historical non-ultrasound risk quoted as up to 6.1% [[gauss-2014]]. The latency is the PACU point: the pneumothorax that follows a supraclavicular block is usually not in the PACU yet.
