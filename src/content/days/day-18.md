...
quiz:
  ...
  - id: pacu-d18-q2
    ...
    options:
      ...
      - text: "Strict bed rest for 24 hours"
        correct: false
        explanation: "Routine bed rest is not supported; it may be used only as a temporizing measure."
  ...
  - id: pacu-d18-q3
    ...
    teachingPoint: "The red flags are a non-postural headache, a late onset, and a focal sign; the alternative diagnoses are subdural hematoma and venous sinus thrombosis."
    difficulty: expert
    ...
    options:
      - text: "When the headache is non-orthostatic or becomes so, when onset is more than 5 days after the puncture, or when there are focal deficits, visual changes, altered consciousness or seizures"
        correct: true
        explanation: "Imaging may be considered for a non-orthostatic headache or late onset (C, low), and should be prompted by focal neurological deficits, visual changes, altered consciousness or seizures, especially postpartum (B, moderate), to evaluate subdural hematoma and cerebral venous sinus thrombosis."
