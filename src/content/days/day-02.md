...
quiz:
  - id: pacu-d02-q1
    ...
    teachingPoint: A structured algorithm was judged to improve recognition or management in about one case in six.
    difficulty: basic
    examAlignment: [ABA-BASIC, ITE, nursing]
    tags: [airway, registry]
    options:
      - text: Earlier recognition or better management in 16% of the 189 cases
        correct: true
        explanation: The authors state that had a structured approach been used, earlier recognition or better management may have occurred in 16% of these cases.
      - text: Prevention of every case
        correct: false
        explanation: The registry describes incidents that occurred; the authors claimed only that recognition or management could have been better in a minority.
      - text: No change, because laryngospasm is unpredictable
        correct: false
        explanation: The authors explicitly identified a fraction of cases where a structured approach would have helped.
      - text: Reduction of intubation to zero
        correct: false
        explanation: The figure sometimes quoted for intubation in this series does not appear in the paper's abstract or results and is not used on this page.
  - id: pacu-d02-q2
    stem: "In the AIMS laryngospasm series, how did most cases present?"
    teachingPoint: Most laryngospasm was clinically obvious, but a meaningful minority presented as obstruction, regurgitation or desaturation alone.
    difficulty: basic
    examAlignment: [ABA-BASIC, ITE, nursing]
    tags: [airway, registry]
    options:
      - text: Clinically obvious in 77%, with airway obstruction, regurgitation or vomiting, and desaturation accounting for the rest
        correct: true
  ...
  - id: pacu-d02-q3
    ...
    options:
      - text: Glossoptosis after extubation
        correct: true
        explanation: Four of the five cases were attributed to glossoptosis after extubation and one to laryngeal mask displacement. All had typical clinical and imaging features and none had a poor outcome.
      - text: Laryngospasm at extubation
        correct: false
        explanation: None of the five was attributed to laryngospasm. The series carries the point that the precipitant in recovery is not always the larynx.
      - text: Aspiration of gastric contents
        correct: false
        explanation: Aspiration is a downstream harm of obstruction in the AIMS series; it was not the precipitant here.
      - text: Bronchospasm
        correct: false
        explanation: The mechanism is inspiratory effort against an obstructed upper airway, not lower airway narrowing.
---
## Why it matters
...
The management ladder itself has no guideline source, and that is now a finding rather than a gap. On 2026-09-06 the two society documents that would be expected to carry it were searched. The Difficult Airway Society extubation guideline was read in full and is now in the ledger. It treats laryngospasm only as a risk, describing it as a protective exaggeration of the normal glottic closure reflex produced by stimulation of the superior laryngeal nerve, and warning that if it is not relieved promptly it may result in post-obstructive pulmonary edema and hypoxic cardiac arrest [[das-extubation-2012]]. It states no sequence. It contains no jaw thrust, no laryngospasm notch and no succinylcholine for post-extubation laryngospasm, and its single pharmacological statement is that doxapram has been used to prevent or treat laryngospasm although robust evidence to support its use for this indication is lacking [[das-extubation-2012]]. The Association of Paediatric Anaesthetists of Great Britain and Ireland has no laryngospasm guideline at all, and the joint paediatric difficult airway guidelines do not mention it. The ladder residents are taught is a textbook construction, not a society recommendation, and neither of those documents has a ledger row yet. The paper usually cited for the Larson maneuver remains a letter without an abstract that a later letter calls unproven. What the succinylcholine label does supply is the dose by route: an average intravenous dose of 0.6 mg/kg to produce blockade and facilitate intubation, an intramuscular dose of up to 3 to 4 mg/kg not exceeding 150 mg in total, with intramuscular onset usually observed in about 2 to 3 min; the label carries no laryngospasm-specific dose and carries a boxed warning for hyperkalemic cardiac arrest in children with undiagnosed myopathy [[fda-succinylcholine-label-2022]]. The five-case series describes supportive management of negative-pressure pulmonary edema only in outline [[bmc-nppe-2025]].
