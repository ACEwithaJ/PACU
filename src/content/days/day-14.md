...
claim: Patients at increased perioperative risk from obstructive sleep apnoea should not leave the recovery area for an unmonitored setting until they are no longer at risk of respiratory depression, and the guideline that imposes this obligation states that the literature cannot say when that is.
...
quiz:
  - id: pacu-d14-q1
    ...
    options:
      ...
      - text: A Category A1 evidence grade from randomised trials
        correct: false
  ...
  - id: pacu-d14-q2
    ...
    options:
      ...
      - text: It contradicts the 2016 SASM guideline
        correct: false
        explanation: The SASM guideline hedges in a different register, acknowledging that few randomised studies exist, but it does not contradict the ASA recommendation.
  ...
  - id: pacu-d14-q3
    ...
    tags: [osa, guidelines]
    options:
      - text: That few randomised studies exist and most recommendations were developed by experts through consensus with evidence grading
        correct: true
