...
## Day 3 — supplemental oxygen hides hypoventilation

**Incidence of hypoventilation or hypercapnia in PACU patients receiving supplemental oxygen.**
Moved here 2026-09-06 when the director cleared Day 3. Nobody has measured how often this
happens in a recovery room. The day teaches the mechanism instead, which is fully sourced:
`fu-2004` phase 1 showed no fall in saturation at all when minute ventilation was halved at an
inspired oxygen fraction of 0.25 or 0.30, while the room-air group desaturated, and phase 2
showed desaturation fourfold higher on room air. The nearest rate is from the ward and is on
...
## Day 17 — urinary retention

**The 500 to 800 mL catheterization threshold trial.** Recorded here 2026-09-06 when the director
cleared Day 17. The trial that the circulating 800 mL figure comes from has no ledger row, because
round 3's new-row CSV was never delivered. Its findings are described on the page inside the
local-practice note, with the caveat that it was a catheterize-at threshold in inpatient
fast-track arthroplasty under spinal anesthesia and not a demonstration that an ambulatory patient
can be left undrained. It should become a cited row in round 4.

## Day 20 — anaphylaxis

**The intramuscular epinephrine dose outside the operating room.** Recorded here 2026-09-06 when
the director cleared Day 20. The perioperative consensus figure of 300 micrograms is cited on the
page. The 500 microgram figure in wide use in national anaphylaxis guidance is not sourced in this
