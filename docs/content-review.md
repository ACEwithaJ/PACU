...
A placeholder in content with `draft: false` fails the build (rule 12), and so does a general
recommendation (rule 15): a page carrying either cannot be cleared for publication.
